...
export function LocationBanner({ locale }: Props) {
  ...
  if (cookieConsent !== "accepted" || country || bannerDismissed || !visible)
    return null;
            ...
            {suggested ? (
              <>
                <p className={styles.banner__title}>
                  {suggested.emoji}{" "}
                  {t("detected", { country: countryName(suggested) })}
                </p>
                <p className={styles.banner__sub}>{t("detectedSub")}</p>
                <div className={styles.banner__actions}>
                  <button
                    className={styles.banner__confirm}
                    onClick={() => confirm(suggested)}
                  >
                    {t("yes")}
                  </button>
                  <button
                    className={styles.banner__change}
